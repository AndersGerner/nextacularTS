...
const Sidebar = ({ menu }) => {
  ...
  return (
    <aside className="sticky z-40 flex flex-col space-y-5 text-white bg-gray-800 dark:bg-gray-900 md:overflow-y-auto md:w-1/6 md:h-screen overscroll-contain">
