...
const Sidebar = ({ menu }) => {
  ...
  return (
    <aside className="sticky z-40 flex flex-col space-y-5 text-white bg-white dark:bg-neutral-900 md:overflow-y-auto md:w-1/5 md:h-screen overscroll-contain">
